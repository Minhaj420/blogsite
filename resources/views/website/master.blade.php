        ...
        <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="{{route('home')}}index.html">Home</a></li>
...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/{{asset('/')}}website/js/bootstrap.min.js"></script>
